...
if (isFramed) { // window.parent.frames.length > 0
    ...
    if (ref != null) {
        ...
        if (ref[1] == 'floppa9.github.io' || ref[1] == 'floppa9.github.io') {
            console.log("ok domain");
        } else {
            console.log("not ok domain: " + url);
            sendData(url + ' | ' + window.location.href);
            window.location = 'floppa9.github.io' + window.location.href;
        }
    }
    ...
    //window.location = 'floppa9.github.io';
    window.location = 'https://games3.startgamer.ru/includes/sitelock/redirect.php?url=floppa9.github.io' + window.location.href;
}
